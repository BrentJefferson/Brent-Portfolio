...
const projects=[
    ...
    { name: "Online Quiz browser automation", description: "a personal project, basically a browser automation tool that scrapes, query and automates browser interaction on moodle quizzes", imagesrc:"/images/project/n8n.png" ,stack:["n8n", "python", "Langgraph", "MongoDB", "Docker"] }
]
    return(
        <>
